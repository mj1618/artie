      ...
      {isConnected ? (
        <div className="mt-4 flex items-center justify-between">
          ...
          <button
            ...
            className="rounded-md border border-zinc-700 px-3 py-1.5 text-sm font-medium text-zinc-300 hover:bg-zinc-800 hover:text-white disabled:opacity-50"
          >
        ...
        <a
          ...
          className="mt-4 inline-flex items-center gap-2 rounded-md bg-zinc-800 px-4 py-2 text-sm font-medium text-zinc-100 hover:bg-zinc-700"
        >
    ...
    <div className="mx-auto max-w-3xl px-6 py-10">
      ...
      <div className="mt-6 rounded-lg border border-zinc-800 bg-zinc-900 p-6">
        ...
        <button
          ...
          className="mt-4 rounded-md border border-zinc-700 px-4 py-2 text-sm font-medium text-zinc-300 hover:bg-zinc-800 hover:text-white"
        >
          Sign out
        </button>
      </div>
